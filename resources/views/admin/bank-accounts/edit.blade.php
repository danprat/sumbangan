...
@section('content')
<div class="max-w-xl">
    <h1 class="text-2xl font-bold tracking-tight text-gray-900">Edit Rekening Bank</h1>

    <form action="{{ route('admin.bank-accounts.update', $bankAccount) }}" method="POST" class="mt-6 space-y-6">
        @csrf
        @method('PUT')
